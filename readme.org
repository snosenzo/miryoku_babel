...
#include "miryoku_layer_alternatives.h"
      ...
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_CANARY_FLIP
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
      ...
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_CANARY_FLIP
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
      ...
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_CANARY_FLIP
...
<<table-layer-taphold(alphas_table=canary, thumbs_table=thumbs-flip, hold_table=hold-flip)>>
...
<<table-layer-taphold(alphas_table=canary)>>
...
<<table-layer-full(current_layer_name="U_TAP", alphas_table=canary, thumbs_table=thumbs-flip)>>
...
<<table-layer-full(current_layer_name="U_TAP", alphas_table=canary, thumbs_table=thumbs)>>
